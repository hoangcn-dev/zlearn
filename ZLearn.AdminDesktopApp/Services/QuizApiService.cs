...
namespace ZLearn.AdminDesktopApp.Services
{
    public interface IQuizApiService
    {
        ...
        Task<Result<CreateResponseDto>> CreateNewCategory(string name);
        Task<Result<DeleteResponseDto>> DeleteCategory(IEnumerable<string> cateIds);
        Task<Result<UpdateResponseDto>> UpdateCategory(string cateId, string name);
    ...
    public class QuizApiService : BaseApiService, IQuizApiService
    {
        ...
        public async Task<Result<CreateResponseDto>> CreateNewCategory(string name)
        {
        ...
        public async Task<Result<DeleteResponseDto>> DeleteCategory(IEnumerable<string> cateIds)
        {
        ...
        public async Task<Result<UpdateResponseDto>> UpdateCategory(string cateId, string name)
        {
